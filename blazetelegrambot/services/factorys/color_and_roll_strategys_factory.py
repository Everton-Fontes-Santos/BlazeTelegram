...
from ...infrastructure.signal_strategys.color_and_roll_strategy import ColorAndRollStrategy
...
class ColorAndRollStrategYFactorys(StrategyFactory):
    ...
    def create(self, signal:Literal[0, 1, 2, 3], pattern: Pattern, broker:str)->SignalStrategy:
        ...
        strat = ColorAndRollStrategy(signal=signal, pattern=pattern, checker=WinChecker(), bet_factory=factory)
