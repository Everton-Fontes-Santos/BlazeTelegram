...
from ...infrastructure.signal_strategys.color_strategy import ColorStrategy
...
class ColorStrategYFactorys(StrategyFactory):
    ...
    def create(self, signal:Literal[0, 1, 2, 3], pattern: Pattern, broker:str)->SignalStrategy:
        ...
        strat = ColorStrategy(signal=signal, pattern=pattern, checker=WinChecker(), bet_factory=factory)
